        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header card-header-text">
                    <h3 class="card-title">แก้ไขการเช็คชื่อ</h3>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-content table-responsive">
                    <table class="table table-hover">
                        ...
                        try {
							...
							WHERE s.std_class = '$cl' && a.atd_date = '$selectDate' ";
                            $stmt = $pdo->query($sql); ?>

                            <form method="post" action="./update//process_form.php">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select name="student_<?php echo $row["std_stdid"] ?>_date_<?php echo $selectDate ?>" id="student_<?php echo $row["std_stdid"] ?>_date_<?php echo $selectDate ?>">
                                                        <option value="<?php echo $row["atd_status"] ?>"><?php echo $row["atd_status"] ?></option>
                ...
                ?>
                    ...
                    <h1 class="text-center text-danger">เลือกวันที่และชั้นเรียนที่ต้องการแก้ไขข้อมูล</h1>
